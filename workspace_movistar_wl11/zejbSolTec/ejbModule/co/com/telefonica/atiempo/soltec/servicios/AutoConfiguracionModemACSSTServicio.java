...
import co.com.telefonica.atiempo.soltec.actividades.df.configuracion.ejb.naked.sb.ACSServicioSTBean;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AutoConfiguracionModemACSSTServicio extends ServicioBasico {
	...
	public void procesar(Object[] obj, boolean esCierreActuacion) throws ATiempoAppEx {
		...
		aCSServicioSTBean.recibirAutoConfiguracion((TR135S) obj[0]);
	}
