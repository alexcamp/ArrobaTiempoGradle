...
/**
 * Bean implementation class for Enterprise Bean: Tmp_deco_tarjeta
 */
public abstract class Tmp_deco_tarjetaBean implements javax.ejb.EntityBean {
	...
	.ejb
	.eb
	.Tmp_deco_tarjetaKey ejbCreate(Long id,Peticion_stLocal pet,String xml) throws CreateException
	{
		setId(id);
		setXml(xml);
		return null;	
	...
	public void ejbPostCreate(Long id,Peticion_stLocal pet,String xml) throws CreateException
	{
		setPeticion_st(pet);
	}	
}
