...
/**
 * Bean implementation class for Enterprise Bean: Tmp_equipo
 */
public abstract class Tmp_equipoBean implements javax.ejb.EntityBean {
     ...
     * ejbCreate
     */
    public co.com.telefonica.atiempo.soltec.ejb.eb.Tmp_equipoKey ejbCreate(
        java.lang.Long id) throws javax.ejb.CreateException {
        setId(id);
        return null;
    }
	public co.com.telefonica.atiempo.soltec.ejb.eb.Tmp_equipoKey ejbCreate(
			java.lang.Long id,Peticion_stLocal peticionLocal,String xml)
	...
	public void ejbPostCreate(java.lang.Long id,Peticion_stLocal peticionLocal,String xml)
			throws javax.ejb.CreateException {
	         setPeticion_st(peticionLocal);
		}
    /**
     * ejbActivate
     */
