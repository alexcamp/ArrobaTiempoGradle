...
//			  CR-14657 Granite - adocarmo - inicio			
			if (esGranite) {
				recursosInterfaces.envioPuntosRedSTBGR(idPeticion.toString(),"F",null);				
			}
			else {
				recursosInterfaces.envioPuntosRedSTB(idPeticion.toString(),"F",null);				
			}
			}
			...
			if(tr719s.getInterfaz().equals(ComunInterfaces.INTERFAZ_BA)){
				...
				recursosBAInterfaces.enviarCuentaCorreo(idPeticion.toString(),"F", null);
				//fin sigres
			}
