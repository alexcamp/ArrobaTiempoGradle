...
public class VerBandejaEsperaSigresAcc extends Accion
{
	protected transient Logger log = LoggerFactory.getLogger(getClass());
		...
		//						Sacamos la pagina Actual y la Paginacion. 
				...
				if(request.getParameter("realizarBusqueda")!=null)
					tabla =(Tabla) biLocal.setearDatoTablaEsperaSigres(map,pagina,intPaginacion,orden.intValue());
...
//				
		...
		private HashMap recuperaFiltrosFijos(HttpServletRequest request)
		{
			...
			map.put( "COD_SUB_ESTADO", UtilesBandeja.sinNull(request.getParameter("otrostipos"), "") );
		...
		private TreeMap getTipoTrabajoOtros()
		{
			...
			t.put("Esperando Unica Respuesta", 		"null");
			t.put("Esperando Primera Respuesta",   	String.valueOf(ComunInterfaces.SUB_ESTADO_ESPERA_SIN_MENSAJE));
			t.put("Primera Respuesta Recibida", 	String.valueOf(ComunInterfaces.SUB_ESTADO_ESPERA_CON_MENSAJE));
			return t;
		}
	}
