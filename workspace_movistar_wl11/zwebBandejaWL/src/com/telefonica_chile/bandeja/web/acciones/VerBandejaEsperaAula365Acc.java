 ...
 *
 */
public class VerBandejaEsperaAula365Acc extends Accion
{
	protected transient Logger log = LoggerFactory.getLogger(getClass());
		...
		//						Sacamos la pagina Actual y la Paginacion. 
				...
				// creo que esto es lo único que cambia con respecto a VerBandejaEsperaTerra365
					tabla =(Tabla) biLocal.setearDatoTablaEsperaAula365(map,pagina,intPaginacion,orden.intValue());
...
//				adocarmo - CR9664 - inicio
				request.setAttribute("templateUsadoParaAula", "SI");
//				adocarmo - CR9664 - fin				
