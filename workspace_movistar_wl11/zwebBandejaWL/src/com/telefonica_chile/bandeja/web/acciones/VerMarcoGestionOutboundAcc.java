...
public class VerMarcoGestionOutboundAcc extends Accion {
...
//			int intAppIdST =2;
			...
			ArrayList tcTituloAux = tcLocal.getTitulosCuadroMandoGO( filtro );
...
//			request.setAttribute("titulosCuadroMando2", tcTitulo2);
			...
			Tabla t = tcLocal.getDatosCuadroMandoGO(  filtro );
			ArrayList datosCM = (ArrayList) t.getElementos();

			// Obtengo las Actividades por Cuadro de Mando.
			ArrayList actcLista = tcLocal.getActividadesCuadroMandoGO( filtro );
