...
// 	tomarForm(document.forma);
 ...
 // limpio los IFRAME
  ...
  forma.action="verMarcoGestionOutbound.acc";
  forma.fTC_Cuadro.value="1";
  forma.fTC_Tipo.value="CUADRO";
  forma.target = "iframe3";
  forma.submit();

  forma.action = "verBandejaGO.acc";
  forma.target = "";
...
function cambioDepto(forma)
{
	...
	forma.action = "verGestionOutbound.acc";
  	//forma.target = "iframeOculto";
  	forma.submit();
	//forma.action = "verBandejaGO.acc";
  	//forma.target = "";
     ...
     <input type="hidden" name="usuario2" value="<%=usuario.getId()%>">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="780">
		    <tbody>
		        <tr>
		            <td>
		                <span class="nombre-app">@Tiempo &gt; Gestión Outbound</span>
		            </td>
		            <td align="right">
...
<form name="form1" action="verBandejaGO.acc" method="post">
...
<form name="forma" action="verGestionOutbound.acc">
...
<table id="filtro-chico" style="display: none" width="100%">
 <tr class="titulo-tabla">
  <td class="titulo-tabla">Filtro de Gestión Outbound</td>
...
<table id="filtro-grande">
	<tr class="titulo-tabla">
		<td colspan="7" class="titulo-tabla">Filtro de Gestión Outbound</td>
		<td align="right" valign="bottom"><a
...
<iframe name="iframe1" style="height: 250px; width: 800px" id="iframe1"
	src="<%=aboutBlank%>"
	frameborder="0"></iframe>
<HR>
<%
