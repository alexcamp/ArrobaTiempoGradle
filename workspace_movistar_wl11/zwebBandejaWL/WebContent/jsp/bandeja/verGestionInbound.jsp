...
function cambioDepto(forma)
{
	...
	forma.action = "verGestionInbound.acc";
  	//forma.target = "iframeOculto";
  	forma.submit();
	//forma.action = "verBandejaGI.acc";
  	//forma.target = "";
     ...
     <input type="hidden" name="usuario2" value="<%=usuario.getId()%>">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="780">
		    <tbody>
		        <tr>
		            <td>
		                <span class="nombre-app">@Tiempo &gt; Gestión Inbound</span>
		            </td>
		            <td align="right">
...
<form name="form1" action="verBandejaGI.acc" method="post">
...
<form name="forma" action="verGestionInbound.acc">
...
<table id="filtro-chico" style="display: none" width="100%">
 <tr class="titulo-tabla">
  <td class="titulo-tabla">Filtro de Gestión Inbound</td>
...
<table id="filtro-grande">
	<tr class="titulo-tabla">
		<td colspan="7" class="titulo-tabla">Filtro de Gestión Inbound</td>
		<td align="right" valign="bottom"><a
