...
public class _Receptor_ST_Stub extends Stub implements Receptor_ST {
    
    private static final String[] _type_ids = {
        "RMI:co.com.telefonica.atiempo.sigres.emu.Receptor_ST:0000000000000000", 
    ...
    public void recibirMensaje(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("recibirMensaje",co.com.telefonica.atiempo.sigres.emu.Receptor_ST.class);
            if (so == null) {
                recibirMensaje(arg0);
                return;
            }
            try {
                ((co.com.telefonica.atiempo.sigres.emu.Receptor_ST)so.servant).recibirMensaje(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
