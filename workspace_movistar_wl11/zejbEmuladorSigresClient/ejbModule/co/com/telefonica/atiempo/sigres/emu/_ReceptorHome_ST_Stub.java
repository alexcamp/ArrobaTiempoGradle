...
public class _ReceptorHome_ST_Stub extends Stub implements ReceptorHome_ST {
    
    private static final String[] _type_ids = {
        "RMI:co.com.telefonica.atiempo.sigres.emu.ReceptorHome_ST:0000000000000000", 
    ...
    public Receptor_ST create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Receptor_ST) in.read_Object(Receptor_ST.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",co.com.telefonica.atiempo.sigres.emu.ReceptorHome_ST.class);
            if (so == null) {
                return create();
            }
            try {
                Receptor_ST result = ((co.com.telefonica.atiempo.sigres.emu.ReceptorHome_ST)so.servant).create();
                return (Receptor_ST)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
