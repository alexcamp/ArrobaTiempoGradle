...
public class _ReceptorHome_Stub extends Stub implements ReceptorHome {
    
    private static final String[] _type_ids = {
        "RMI:co.com.telefonica.atiempo.sigres.emu.ReceptorHome:0000000000000000", 
    ...
    public Receptor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Receptor) in.read_Object(Receptor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",co.com.telefonica.atiempo.sigres.emu.ReceptorHome.class);
            if (so == null) {
                return create();
            }
            try {
                Receptor result = ((co.com.telefonica.atiempo.sigres.emu.ReceptorHome)so.servant).create();
                return (Receptor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
