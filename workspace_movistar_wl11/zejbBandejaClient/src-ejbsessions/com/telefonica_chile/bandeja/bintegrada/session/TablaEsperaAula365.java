...
//	este metodo difiere para terra y BA y obviamente para Aula
		...
		String sql =
			"select * from ( "
				+ "   select b.COD_PET_CD,b.PETI_NUMERO,b.COD_LOC," +
				  ...
				  " b.COD_CLI_CD,b.PETI_FECHA_INGRESO,b.ESPE_ID,b.PETI_FECHA_TERMINO,bi.BIPE_FECHA_INICIO," +
				...
				+ " where me.PETI_NUMERO=b.PETI_NUMERO AND b.COD_DPT=DEPA.COD_DPT " +
					...
					// OJO con el COD_ESTADO y con COD_ACTIVIDAD_GENERADORA
					"and me.COD_ESTADO=3 and me.COD_ACTIVIDAD_GENERADORA='Director de Flujos.Configuracion_Aula.Configurar_Aula' " +
					
					" and bi.BIPE_FECHA_FIN is null" +
					
					// OJO con el ACT_ID que posiblemente cambie
					//" and bi.ACT_ID=1082 "
					" and bi.ACT_ID=1502 "
				+ sqlWhereFijo 
				+ " ) subtabla where row >= "
...
//	este metodo es el que difiere entre BA y Terra y obviamente en Aula
	private int getCantidadElementos(HashMap filtro)
	{
		int cantElementos = 0;
		String sqlWhereFijo = getWhereFijo(filtro);

        // OJO que tal vez el COD_ESTADO cambie y OJO con el valor que le puse a COD_ACTIVIDAD_GENERADORA
        // Tal vez haya que agregar algún campo mas
		String sql = " select count(B.PETI_NUMERO) as TOTAL from vpistbba.peticion B,atiempo.mensaje_estado_ba me,vpistbba.bitacora_peticion bi" +
			" where me.COD_ESTADO=3 and me.COD_ACTIVIDAD_GENERADORA='Director de Flujos.Configuracion_Aula.Configurar_Aula'" +
			"  and me.PETI_NUMERO=b.PETI_NUMERO" +
			"  and bi.PETI_NUMERO=b.PETI_NUMERO" +
			
			//OJO con el ACT_ID que seguramente es otro
			//"  and bi.ACT_ID=1082" +
			"  and bi.ACT_ID=1502" +
