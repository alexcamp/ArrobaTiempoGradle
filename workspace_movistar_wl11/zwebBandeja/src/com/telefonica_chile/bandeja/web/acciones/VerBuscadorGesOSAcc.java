...
public class VerBuscadorGesOSAcc extends Accion
{
	...
	protected void ejecutar(HttpServletRequest request) throws Evento
	{
		...
		try
		{
			...
			log.info("folioAtis:" +folioAtis+" rut:" +rut+" rutDv:" +rutDv+" folioPC:" +folioPC+" idTypePc:" +idTypePc);
			...
			if (codConsulta!=-1){
				...
				buscadorPeticion.setCodBusqueda(BuscadorPeticionUtiles.COD_BUSCADOR_GES_OS);
