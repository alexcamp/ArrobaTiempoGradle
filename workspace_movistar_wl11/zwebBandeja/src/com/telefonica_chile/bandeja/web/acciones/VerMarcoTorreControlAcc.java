 ...
 */
public class VerMarcoTorreControlAcc extends Accion {
...
//			log.debug("VerNuevaTorreControlAcc");
			...
			Tabla t = tcLocal.getDatosCuadroMando(  filtro );
			ArrayList datosCM = (ArrayList) t.getElementos();

			// Obtengo las Actividades por Cuadro de Mando.
			ArrayList actcLista = tcLocal.getActividadesCuadroMando( filtro );
