...
public class PeticionesSupervisadoAcc extends Accion
{
	...
	protected void ejecutar(HttpServletRequest request) throws Evento
	{
		...
		try{
			...
			ArrayList listRolesUsuario = (ArrayList)usuariosSession.recuperarRolesUsuario(new Long(request.getParameter("usua_supervisado")));
...
//			}
			...
			map.put("USUA_ID", request.getParameter("usua_supervisado"));
			...
			ArrayList listaUsuariosQueSuperviso=biLocal.recuperaUsuariosQueSuperviso(idUsuario);
			...
			request.setAttribute("listaUsuariosQueSuperviso",listaUsuariosQueSuperviso);
