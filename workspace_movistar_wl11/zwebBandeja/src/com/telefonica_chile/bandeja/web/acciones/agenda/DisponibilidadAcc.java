...
//			}
//
//			// Ya se obtuvieron todos los parametros.
//			
//			// Obtengo la Familia del Segmento
//
//			// Obtengo la Familia de los PS's
//			
//			// Valido si ya está asignada la Petición.
//			 
//			// Obtengo Tipo Compromiso.
//
//			// Muestro según TipoCompromiso			
//			
//			
//			Bloque bloqueLimite;
//			/**Filtros Asignación...**/
...
//					arregloPs);
//
//			log.debug("rol = recuperaRolActividad(codActividad);");
...
//			log.debug("Parametros Disp");
//			log.debug("arregloPs            == " + arregloPs );
//			log.debug("arregloOperComercial == " + arregloOperComercial );
//			log.debug("idAgencia            == " + idAgencia );
//			log.debug("========================= ");
//			log.debug("LLAMADA A recuperarActividadesSessionRemoto");
