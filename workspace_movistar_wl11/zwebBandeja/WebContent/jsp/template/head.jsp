...
<%
	...
	System.out.println("head.jsp ::: redirectBandejaPushURL = "+redirectBandejaPushURL);
     ...
     <input type="hidden" name="usuario2" value="<%=usuario.getId()%>">
					...
					<SELECT class="menu-cabecera" onchange="javascript:cambiaPaginaMenuCabecera(this)">
						...
						<%
							...
							for (Iterator iterator = menuPadre.getMenuHijos().iterator();iterator.hasNext();) {
								...
								if (menuHijo.getMenuDescripcion().equals("Bandeja Reportes")){
									url=menuHijo.getMenuUrl()+"?user="+usuario.getNombre();
								}else{
		...
		<table border="0" cellpadding="0" cellspacing="0" width="780">
		    <tbody>
		        <tr>
		            <td>
		                <span class="nombre-app">@Tiempo &gt; Bandeja de Entrada</span>
		            </td>
		            <td align="right">
