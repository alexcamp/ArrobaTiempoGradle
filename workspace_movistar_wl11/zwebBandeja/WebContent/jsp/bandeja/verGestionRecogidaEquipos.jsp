...
{
	//alert(petinumero);
	var url="<%=ApplicationConfig.getUrlBase(ApplicationConfig.APP_VPISTBBA)%>/"+"BuscadorPeticionesCo.acc?folio="+petinumero+"&bandeja=RecogidaEquipos"+"&ID_USUARIO=<%=usuario.getId()%>";
	if (newWinIn != null)
		newWinIn.close();
	//alert(url);
     ...
     <input type="hidden" name="usuario2" value="<%=usuario.getId()%>">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="780">
		    <tbody>
		        <tr>
		            <td>
		                <span class="nombre-app">@Tiempo &gt; Gestor Avanzado Recogida Equipos</span></td>
		            <td align="right">
...
<form name="formaBuscar" action="verGestionRecogidaEquipos.acc" method="post">
