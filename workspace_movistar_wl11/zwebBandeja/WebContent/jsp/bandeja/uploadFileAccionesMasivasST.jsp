...
<TABLE class="elementos-filtro" width="300" height="170">
	<tr><TD class="titulo-tabla">Cargar archivo con incidencias a cerrar actividad</TD></tr>
	<tr><TD><br></TD></tr>
	<tr><TD><DIV align="center">
	<!--<FORM name="form1" enctype="multipart/form-data" action="UploadFile.acc" method="Post">-->
	<FORM name="form1" enctype="multipart/form-data" action="<%=((AplicacionDTO) mapAplicaciones.get("ATST")).getApUrlBase()%>/CancelaActividadByFile" method="Post">
		<TABLE>
			<tr><TD>
