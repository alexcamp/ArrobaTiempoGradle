...
public class _AAsignarRecursosManualSTBGRHome_Stub extends Stub implements AAsignarRecursosManualSTBGRHome {
    
    private static final String[] _type_ids = {
        "RMI:co.com.telefonica.atiempo.vpistbba.actividades.df.asignacion.ejb.sb.AAsignarRecursosManualSTBGRHome:0000000000000000", 
    ...
    public AAsignarRecursosManualSTBGR create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AAsignarRecursosManualSTBGR) in.read_Object(AAsignarRecursosManualSTBGR.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",co.com.telefonica.atiempo.vpistbba.actividades.df.asignacion.ejb.sb.AAsignarRecursosManualSTBGRHome.class);
            if (so == null) {
                return create();
            }
            try {
                AAsignarRecursosManualSTBGR result = ((co.com.telefonica.atiempo.vpistbba.actividades.df.asignacion.ejb.sb.AAsignarRecursosManualSTBGRHome)so.servant).create();
                return (AAsignarRecursosManualSTBGR)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
