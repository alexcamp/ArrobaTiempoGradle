...
import co.com.telefonica.atiempo.vpistbba.actividades.df.configuracion.ejb.sb.AAprovisionamientoRedIntLocalHome;
 ...
 * @author VictorMan
 */
public class AAprovisionamientoRedIntFactory implements IActividadFactoryEJBService {
	...
	public IActividadEJB getActividadEJB() throws TnProcesoExcepcion {
		...
		try {
			AAprovisionamientoRedIntLocalHome ejbHome= (AAprovisionamientoRedIntLocalHome)HomeFactory.getHome(AAprovisionamientoRedIntLocalHome.JNDI_NAME);
