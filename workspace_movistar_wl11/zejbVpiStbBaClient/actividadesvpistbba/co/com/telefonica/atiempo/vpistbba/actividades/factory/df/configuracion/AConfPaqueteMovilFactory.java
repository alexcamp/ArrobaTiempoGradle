...
import co.com.telefonica.atiempo.vpistbba.actividades.df.configuracion.ejb.sb.AConfPaqueteMovilLocalHome;
 ...
 */
public class AConfPaqueteMovilFactory implements IActividadFactoryEJBService {
	...
	public IActividadEJB getActividadEJB() throws TnProcesoExcepcion {
		...
		try {
			AConfPaqueteMovilLocalHome ejbHome = (AConfPaqueteMovilLocalHome) HomeFactory
					.getHome(AConfPaqueteMovilLocalHome.JNDI_NAME);
			actEJB = ejbHome.create();
		} catch (CreateException e) {
			throw new TnProcesoExcepcion(e.getClass().getName() + " : El EJB "
					+ AConfPaqueteMovilLocalHome.JNDI_NAME
