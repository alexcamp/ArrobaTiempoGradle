...
import co.com.telefonica.atiempo.vpistbba.inventario.ejb.AConsultarEstadoDTHLocalHome;
 ...
 */
public class AConsultarEstadoDTHFactory implements IActividadFactoryEJBService {
	...
	public IActividadEJB getActividadEJB() throws TnProcesoExcepcion {
		...
		try {
			AConsultarEstadoDTHLocalHome ejbHome= (AConsultarEstadoDTHLocalHome)HomeFactory.getHome(AConsultarEstadoDTHLocalHome.JNDI_NAME);
			actEJB=ejbHome.create();
		} catch (CreateException e) {
			throw new TnProcesoExcepcion(e.getClass().getName() + " : El EJB " + AConsultarEstadoDTHLocalHome.JNDI_NAME + " no es posible levantarlo" + e.getMessage());
