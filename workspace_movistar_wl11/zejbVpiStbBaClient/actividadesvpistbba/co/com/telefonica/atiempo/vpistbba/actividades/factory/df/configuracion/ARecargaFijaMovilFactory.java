...
import co.com.telefonica.atiempo.vpistbba.actividades.df.configuracion.ejb.sb.ARecargaFijaMovilLocalHome;
 ...
 */
public class ARecargaFijaMovilFactory implements IActividadFactoryEJBService {
	...
	public IActividadEJB getActividadEJB() throws TnProcesoExcepcion {
		...
		try {
			ARecargaFijaMovilLocalHome ejbHome = (ARecargaFijaMovilLocalHome) HomeFactory
					.getHome(ARecargaFijaMovilLocalHome.JNDI_NAME);
			actEJB = ejbHome.create();
		} catch (CreateException e) {
			throw new TnProcesoExcepcion(e.getClass().getName() + " : El EJB "
					+ ARecargaFijaMovilLocalHome.JNDI_NAME
