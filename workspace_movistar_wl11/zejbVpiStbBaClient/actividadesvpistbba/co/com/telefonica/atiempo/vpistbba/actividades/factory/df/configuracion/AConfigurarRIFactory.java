 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AConfigurarRIFactory implements IActividadFactoryEJBService{

	/* (non-Javadoc)
	 * @see co.com.telefonica.atiempo.actividades.IActividadFactoryEJBService#getActividadEJB()
	 */
	public AConfigurarRIFactory() {
		super();
	...
	public IActividadEJB getActividadEJB() throws TnProcesoExcepcion {
		...
		try {
			AConfigurarRILocalHome ejbHome= (AConfigurarRILocalHome)HomeFactory.getHome(AConfigurarRILocalHome.JNDI_NAME);
