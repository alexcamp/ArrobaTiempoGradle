...
@Stateless
public class ClienteEmuladorBean_ST implements javax.ejb.SessionBean, ClienteEmulador_ST{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4951807041420598562L;

	private static Logger logger = Logger.getLogger(ClienteEmuladorBean_ST.class);
