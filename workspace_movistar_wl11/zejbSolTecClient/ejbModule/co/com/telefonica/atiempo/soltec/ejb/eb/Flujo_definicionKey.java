...
public class Flujo_definicionKey implements java.io.Serializable {
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof co.com.telefonica.atiempo.soltec.ejb.eb.Flujo_definicionKey) {
			co.com.telefonica.atiempo.soltec.ejb.eb.Flujo_definicionKey o =
				(co
					.com
					.telefonica
					.atiempo
