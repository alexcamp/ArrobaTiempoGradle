...
import co.com.telefonica.atiempo.soltec.actividades.df.configuracion.ejb.naked.sb.ACSServicioSTLocal;
import co.com.telefonica.atiempo.soltec.actividades.df.configuracion.ejb.naked.sb.ACSServicioSTLocalHome;
...
public class ACSServicioDelegate implements ACSServicioInterfaz{
	...
	private ACSServicioSTLocal servicios;
	//private ACSSelectorServicio selectorServicio;

	public ACSServicioDelegate() throws ATiempoAppEx {
		try {
			
			servicios = ((ACSServicioSTLocalHome) HomeFactory.getHome(ACSServicioSTLocalHome.JNDI_NAME)).create();
	 ...
	 * @param integer
	 */
	public void eliminarModemACS(ModemSTDTO modemDTO, ActividadEJBDTO actDto, Long petiNumero, String nombreActividad, Integer actiID) {
