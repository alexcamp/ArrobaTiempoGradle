...
public class Actividad_flujoKey implements java.io.Serializable {
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof co.com.telefonica.atiempo.soltec.ejb.eb.Actividad_flujoKey) {
			co.com.telefonica.atiempo.soltec.ejb.eb.Actividad_flujoKey o =
				(co
					.com
					.telefonica
					.atiempo
