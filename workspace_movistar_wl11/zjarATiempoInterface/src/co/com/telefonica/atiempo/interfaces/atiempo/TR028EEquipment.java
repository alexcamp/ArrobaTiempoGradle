...
//
// $Id: TR028EEquipment.java,v 1.1 2011/03/30 18:25:34 lfmartinez Exp $
//-----------------------------------------------------------------------
 ...
 */
public class TR028EEquipment implements Serializable {
	...
	public boolean equals(Object arg0) {
		if (arg0 instanceof TR028EEquipment) {
			TR028EEquipment other = (TR028EEquipment) arg0;
			return EqualityUtilities.equals(elementSerial, other.elementSerial) &&
					...
					EqualityUtilities.equals(equipmentState, other.equipmentState) &&
