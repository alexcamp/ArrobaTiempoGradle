 ...
 *  
 */
public class ObtenerPuntosDeRed_ST extends TRMessageProcess_ST {
    ...
    public List emulateResponse(String message) {
        ...
        salida = (TR012S) getXmlProcessor().unmarshal(ServiceLocatorEmulator_ST.getRecurso("TR_012_S.xml"));
...
//        }
        ...
        OPR_Respuesta_ST r = new OPR_Respuesta_ST(responseMessage);
        respuestas.add(r);
        return respuestas;
    }
}
