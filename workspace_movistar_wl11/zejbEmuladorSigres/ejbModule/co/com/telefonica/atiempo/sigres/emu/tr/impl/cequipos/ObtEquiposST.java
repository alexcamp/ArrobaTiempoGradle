 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ObtEquiposST extends TRMessageProcess_ST{
    ...
    public List emulateResponse(String msg) {
        ArrayList respuestas = new ArrayList();
		   ...
		   if (resultado.equals("ok")) {
			   ...
			   salida.setErrorCode(10000);
			   salida.setErrorMessage("Problemas al parsear el telefono.");
		   }
		   /*
			* Se genera el o los String de salida y se agregan a la lista de respuestas.
			*/
		   String responseMessage = getXmlProcessor().marshal(salida);
		   ObtEquipos_RespuestaST r = new ObtEquipos_RespuestaST(responseMessage);
		   respuestas.add(r);
		   return respuestas;
    }
