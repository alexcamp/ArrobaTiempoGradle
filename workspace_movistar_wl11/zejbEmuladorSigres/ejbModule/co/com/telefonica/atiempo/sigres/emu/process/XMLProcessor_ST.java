 ...
 *  
 */
public class XMLProcessor_ST {
    private Mapping localMapping;

    public XMLProcessor_ST() {
        init();
    }

    private void init() {
        Mapping m = new Mapping();
		m.loadMapping(new InputSource(ServiceLocatorEmulator_ST.getRecurso("mapping.xml")));
		localMapping = m;
    }
    ...
    public static void main(String[] args) {
        ...
        TR012S tr = (TR012S)xml.unmarshal(ServiceLocatorEmulator_ST.getRecurso("TR_012_S.xml"));
