 ...
 *
 */
public class ConfigurarInternetCambioPlan extends TRMessageProcess {
	...
	public List emulateResponse(String msg) {
		...
		/* Posibles respuestas*/
		TR039S ack = null;
		TR040S respuesta = null;
		TR034S cierre = null;
		/* Instancia del mensaje de entrada.*/
		entrada = (TR038E) getXmlProcessor().unmarshal(msg);

		/*
		 * Se consulta el properties para conocer el estado de respuesta
		 * definido para este caso emulado.
		 */
		String resultado = getTrProperties().getProperty("tr_039_s.status");

		if (resultado.equalsIgnoreCase("ok")) {
			/* Instancias de las respuestas de SIGRES*/
			ack = (TR039S) getXmlProcessor().unmarshal(ServiceLocatorEmulator.getRecurso("tr_039_s.xml"));
			respuesta = (TR040S) getXmlProcessor().unmarshal(ServiceLocatorEmulator.getRecurso("tr_040_s.xml"));
			...
			CICP_ACK r_ack = new CICP_ACK(ack_msj);
			CICP_Respuesta r_respuesta = new CICP_Respuesta(respuesta_msj);
