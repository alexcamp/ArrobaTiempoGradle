 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ConsultaModems extends TRMessageProcess {
	...
	public List emulateResponse(String msg) {
		/* Este ArrayList es para cargar las respuestas*/        
			   ...
			   salida = (TR022S) getXmlProcessor().unmarshal(ServiceLocatorEmulator.getRecurso("TR_022_S.xml"));
			   ...
			   CM_Respuesta r = new CM_Respuesta(responseMessage);
			   respuestas.add(r);
			   return respuestas;
	}
