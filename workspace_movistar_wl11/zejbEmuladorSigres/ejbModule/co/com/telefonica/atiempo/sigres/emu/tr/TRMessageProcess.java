 ...
 */
public abstract class TRMessageProcess {
	
	protected String entranceClass;
	
	protected List outputMessages;
    ...
    private Properties trProperties = ServiceLocatorEmulator.getTRProperties();
	 ...
	 * @return
	 */
	public String getEntranceClass() {
