 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ObtenerConfBA extends TRMessageProcess {
	...
	public List emulateResponse(String msg) {
	   ...
	   salida = (TR014S) getXmlProcessor().unmarshal(ServiceLocatorEmulator.getRecurso("TR_014_S.xml"));
	   ...
	   ObCBA_Respuesta r = new ObCBA_Respuesta(responseMessage);
	   respuestas.add(r);
	   return respuestas;
	}
