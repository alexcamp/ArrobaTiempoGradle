 ...
 */
public class VistaGlobalEmu extends TRMessageProcess{
	...
	public List emulateResponse(String msg) {
	   ...
	   salida = (TR025S) getXmlProcessor().unmarshal(ServiceLocatorEmulator.getRecurso("TR_025_S.xml"));
	   ...
	   VistaGlobalEmuRespuesta r = new VistaGlobalEmuRespuesta(responseMessage);
	   respuestas.add(r);
