 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ActualizarInventarioBA_ST extends TRMessageProcess_ST{
	...
	public List emulateResponse(String msg) {
		/* Este ArrayList es para cargar las respuestas*/        
		   ...
		   salida = (TR007S) getXmlProcessor().unmarshal(ServiceLocatorEmulator_ST.getRecurso("TR_007_S.xml"));
		   ...
		   ACINV_Respuesta_ST r = new ACINV_Respuesta_ST(responseMessage);
		   respuestas.add(r);
		   return respuestas;
	}
