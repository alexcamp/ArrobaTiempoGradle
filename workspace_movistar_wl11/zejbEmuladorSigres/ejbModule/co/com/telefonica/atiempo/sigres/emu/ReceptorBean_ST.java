...
import co.com.telefonica.atiempo.sigres.emu.process.Despachador_ST;
...
@Stateless
public class ReceptorBean_ST implements javax.ejb.SessionBean, Receptor_ST {
	...
	public void recibirMensaje(String mensaje){
		...
		Despachador_ST d = new Despachador_ST(mensaje);
