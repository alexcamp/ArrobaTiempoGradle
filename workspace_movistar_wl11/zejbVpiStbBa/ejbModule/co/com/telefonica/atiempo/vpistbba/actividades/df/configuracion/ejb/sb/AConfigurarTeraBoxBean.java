...
/**
 * Bean implementation class for Enterprise Bean: AConfigurarTeraBox
 */
public class AConfigurarTeraBoxBean
	extends
	...
	protected void onInicioActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		log.debug("Ejecutando AConfigurarTEraBox: nro peticion: [ "+act.getNumeroPeticion()+"]");
		...
		try{
			...
			if(!act.getDato(DATOS_ATVPISTBBA.DIRECTOR_DE_FLUJOS.fluj_reversa).equals("S")){
				...
				recursosBADelegate.enviarConfiguracionTeraBox(act, act.getNumeroPeticion(), act.getCodigoActividad(), (PsVsOcVO)it_ps.next());
			}else{
			...
			throw new TnProcesoExcepcion ("Error en Actividad AConfigurarTeraBox ", appEx);
		}
	}
	/* (non-Javadoc)
