 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class CambiarNumeroBAMQ extends QManagerService {


	private static final String QUEUE = "jms/QMAT/IT_BUS_NOV_CAM_NUM_Q";
	
	/**
	 * @param queue
	 * @throws ATiempoAppEx
	 */
	public CambiarNumeroBAMQ() throws ATiempoAppEx {
		super(QUEUE);
	...
	{
		if (obj instanceof TR015E)
		{
			TR015E tr015e = (TR015E) obj;
			tr015e.setId(Utiles.ConversorGuion(filtraInvalidaCharacter(tr015e.getId())));
		}
		return obj;
	}
