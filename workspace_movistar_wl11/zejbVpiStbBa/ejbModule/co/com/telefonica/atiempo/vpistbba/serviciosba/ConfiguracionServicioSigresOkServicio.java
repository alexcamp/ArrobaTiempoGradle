...
public class ConfiguracionServicioSigresOkServicio extends ServicioBasico {
	...
	protected void procesar(Object[] obj) throws ATiempoAppEx {
		...
		try{
			...
			Mensaje_estado_baKey mensajeEstadoBAKey = new Mensaje_estado_baKey(new Long(tr032s.getId()));
			...
			if (peticionesDelegate.tieneCodActividadNoAvance(mensajeEstadoBALocal.getCod_actividad_generadora())){
				...
				Recursos_linea_basicaLocal linea_basicaLocal = linea_basicaHome.findByPeticion(new Long(tr032s.getAtiempoRequestNumber()));
				
				if (linea_basicaLocal.getReinstalacion_internet() != null && linea_basicaLocal.getReinstalacion_internet().indexOf("true") != -1){
					configurarCuenta(new Long(tr032s.getAtiempoRequestNumber()));
				}			
			}
	...
	protected Object[] convertirMensaje(String mensaje) throws ATiempoAppEx {
		...
		TR032S tr032S = (TR032S) XMLUtilities.unmarshall(mensaje);
		obj[0] = tr032S;
		return obj;
	}
