...
/**
 * Bean implementation class for Enterprise Bean: AConfiguracionInternetMovil
 */
public class AConfiguracionInternetMovilBean
	extends
	...
	protected void onInicioActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		log.debug("--Pasa por metodo onInicioActividadVPI de AConfiguracionInternetMovilBean, en la actividad "+ act.getCodigoActividad()+", para la petición: "+act.getNumeroPeticion());
		...
		try {
			...
			log.error("AConfiguracionInternetMovilBean: onInicioActividadVPI: Error al intentando enviar la información de Internet Movil hacia el Broker. "+e.toString());
		}
	}
