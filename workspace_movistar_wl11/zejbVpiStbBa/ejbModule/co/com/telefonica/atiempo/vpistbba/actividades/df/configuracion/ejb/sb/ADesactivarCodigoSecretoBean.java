...
/**
 * Bean implementation class for Enterprise Bean: ADesactivarCodigoSecreto
 */
public class ADesactivarCodigoSecretoBean extends	AAltamiraAbstractAutomaticActivityRIBean {
	...
	protected String getATiempoServiceName() {
		return ComunInterfaces.DESACT_CLAVE_SECRETA;
	}
