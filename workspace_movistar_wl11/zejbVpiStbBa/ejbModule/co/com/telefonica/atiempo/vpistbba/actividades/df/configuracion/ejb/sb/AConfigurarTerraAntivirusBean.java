...
/**
 * Bean implementation class for Enterprise Bean: AConfigurarTerraAntivirus
 */
public class AConfigurarTerraAntivirusBean
	extends
	...
	protected void onInicioActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		log.debug("--Pasa por metodo onInicioActividadVPI de AConfigurarTerraAntivirusBean, en la actividad "+ act.getCodigoActividad()+", para la petición: "+act.getNumeroPeticion());
		...
		try{
			...
			Collection listaMensajeLocal =  mensajeEstadoBaLocalHome.findByPetiNumeroErrorActividad(act.getNumeroPeticion(), "6", ComunInterfaces.COD_ACT_CONFIG_TERRA_ANTIVIRUS);
		...
		/*if (listaMensajeLocal.isEmpty()){
			...
			throw new TnProcesoExcepcion("Error en Actividad Configurar Terra Antivirus", e);
