...
/**
 * Bean implementation class for Enterprise Bean: ADesinstalarDTHMasivo
 */
public class ADesinstalarDTHMasivoBean
	extends
	...
	protected void onInicioActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		...
		log.debug("onInicioActividad ADesinstalarDTHMasivoBean " + nroPeticion);
		int decosAlta = 0;
		int decosBaja = 0;
		...
		if(decosBaja < ComunInterfaces.NRO_DECOS_MASIVO){
			...
			act.setObservacion("Se inhibe la actividad de DesinstalarDTHMasivo por no ser de tipo Masivo");
			act.setDato(DATOS_ATVPISTBBA.DIRECTOR_DE_FLUJOS.INSTALACION.inst_ok, "N");
			log.debug("Se finaliza la Actividad DesinstalarDTHMasivo[" + nroPeticion + "]");
		 }else{
	...
	protected void onTerminoActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		// TODO Auto-generated method stub
		Long nroPeticion = act.getNumeroPeticion();
		log.debug("onTerminoActividad DesinstalarDTHMasivo " + nroPeticion);
