...
/**
 * Bean implementation class for Enterprise Bean: AControlDesinstalacionDTHMasivo
 */
public class AControlDesinstalacionDTHMasivoBean
	extends
	...
	protected void onInicioActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		...
		log.debug("onInicioActividad AControlDesinstalacionDTHMasivoBean " + nroPeticion);
	}
	...
	protected void onTerminoActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		// TODO Auto-generated method stub
		Long nroPeticion = act.getNumeroPeticion();
		log.debug("onTerminoActividad AControlDesinstalacionDTHMasivoBean " + nroPeticion);
	}
