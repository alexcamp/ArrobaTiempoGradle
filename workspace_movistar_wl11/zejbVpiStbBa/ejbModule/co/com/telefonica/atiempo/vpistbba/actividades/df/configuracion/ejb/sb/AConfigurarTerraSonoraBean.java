...
/**
 * Bean implementation class for Enterprise Bean: AConfigurarTerraSonora
 */
public class AConfigurarTerraSonoraBean
	extends
	...
	protected void onInicioActividadVPI(ActividadEJBDTO act) throws TnProcesoExcepcion {
		log.debug("--Pasa por metodo onInicioActividadVPI de AConfigurarTerraSonoraBean, en la actividad "+ act.getCodigoActividad()+", para la petición: "+act.getNumeroPeticion());
...
//		TODO: 23/10/2009 - Raúl Ernesto Triviño Alvarado - Ajuste del requerimeinto 00030351 - Se coloca for para mandar mensaje para cada ps
		...
		try{
			...
			Collection listaMensajeLocal =  mensajeEstadoBaLocalHome.findByPetiNumeroErrorActividad(act.getNumeroPeticion(), "6", ComunInterfaces.COD_ACT_CONFIG_TERRA_SONORA);
