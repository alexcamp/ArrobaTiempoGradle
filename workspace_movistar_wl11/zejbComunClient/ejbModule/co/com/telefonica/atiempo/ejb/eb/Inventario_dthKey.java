...
/**
 * Key class for Entity Bean: Inventario_dth
 */
public class Inventario_dthKey implements java.io.Serializable {
	...
	/**
	 * Creates an empty key for Entity Bean: Inventario_dth
	 */
	public Inventario_dthKey() {
	}
	/**
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof co.com.telefonica.atiempo.ejb.eb.Inventario_dthKey) {
			co.com.telefonica.atiempo.ejb.eb.Inventario_dthKey o =
				(co.com.telefonica.atiempo.ejb.eb.Inventario_dthKey) otherKey;
	...
	/**
	 * Creates a key for Entity Bean: Inventario_dth
	 */
	
	public Inventario_dthKey(Long idPeticion)
	{
		PeticionKey key=new PeticionKey(idPeticion);
		privateSetPeticionKey(key);
	}
	public Inventario_dthKey(
