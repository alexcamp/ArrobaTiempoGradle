...
public class _MailSessionHome_Stub extends Stub implements MailSessionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.telefonica_chile.comun.mail.session.MailSessionHome:0000000000000000", 
    ...
    public MailSession create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (MailSession) in.read_Object(MailSession.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.telefonica_chile.comun.mail.session.MailSessionHome.class);
            if (so == null) {
                return create();
            }
            try {
                MailSession result = ((com.telefonica_chile.comun.mail.session.MailSessionHome)so.servant).create();
                return (MailSession)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
