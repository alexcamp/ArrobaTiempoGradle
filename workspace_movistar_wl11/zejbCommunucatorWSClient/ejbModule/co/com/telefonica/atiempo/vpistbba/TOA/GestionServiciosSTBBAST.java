 ...
 * Ventana - Preferencias - Java - Estilo de código - Plantillas de código
 */
public class GestionServiciosSTBBAST extends GestionServiciosVariadoST{
	private transient Logger log = LoggerFactory.getLogger (getClass()) ;
	private int inboundReintentos;
	private int outboundReintentos;
	

	public String servicioInBound(ITRxxxBase trXXXe, Long idAplicacion , Long reintentos, String observaciones, String xaTelephoneData, String producto, String error ) {
		try {
