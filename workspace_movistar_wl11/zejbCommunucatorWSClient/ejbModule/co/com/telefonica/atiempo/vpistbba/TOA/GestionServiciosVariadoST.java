 ...
 * Ventana - Preferencias - Java - Estilo de código - Plantillas de código
 */
public class GestionServiciosVariadoST {
	private transient Logger log = LoggerFactory.getLogger (getClass()) ;

	public String servicioInBound(ITRxxxBase trXXXe, Long idAplicacion ){
		try {
			...
			xml += this.obtenerInterfaz(trXXXeClassName, "inb:inbound_interface_request", idAplicacion);
//			xml += this.obtenerInterfaz(trXXXeClassName, "data", idAplicacion);
			...
			if(error.equals("0")){
				String properties = "<properties>" +
										"<property>"+
											"<label>"+this.buscarInformacion(ComunInterfaces.A_ACS_RESULT_CODE)+"</label>"+
											"<value>"+this.buscarInformacion(ComunInterfaces.DELIVERED)+"</value>"+
										"</property>"+
										"<property>" +
											"<label>"+this.buscarInformacion(ComunInterfaces.A_ACS_RESULT_DESCRIPTION)+"</label>"+
											"<value>"+this.buscarInformacion(ComunInterfaces.DELIVERED)+"</value>"+
										"</property>";
			...
			return CommunicatorWSDelegate.enviarMensajeEstructurado(trXXXe,xml,trXXXeClassName );
	 ...
	 * @return
	 */
	protected String obtenerInterfaz(String trXXXeClassName, String arreglo, Long idAplicacion ) {
	 ...
	 * @return
	 */
	protected String getValorMetodo(ITRxxxBase trXXXe, String metodo) {
		// TODO Apéndice de método generado automáticamente
		try {
...
//			System.out.println("Mensaje Resultante= "+apptNumber);
	...
	public String servicioOutBound(ITRxxxBase trXXXe, Long idAplicacion){
		try{
	...
	protected String buscarInformacion( String dato) {
		try {
			// TODO Apéndice de método generado automáticamente
