 ...
 * Ventana - Preferencias - Java - Estilo de código - Plantillas de código
 */
public class GestionRefrescarRecursosTV extends GestionServiciosVariado{
	private transient Logger log = LoggerFactory.getLogger (getClass()) ;

	public String servicioInBound(ITRxxxBase trXXXe, Long idAplicacion, Mensaje_agenda_scLocal mensaje_agenda_local, String error, String des_error ){
		try {
...
//				String des_error = getValorMetodo(trXXXe, "getDescripcionError");
	...
	public String servicioOutBound(ITRxxxBase trXXXe, Long idAplicacion, Mensaje_agenda_scLocal mensaje_agenda_local,String error){
		try{
			Conexion_InterfazLocalHome conexionInterfazHome = (Conexion_InterfazLocalHome) HomeFactory.getHome(Conexion_InterfazLocalHome.JNDI_NAME);
			CommunicatorWSDelegate CommunicatorWSDelegate = new CommunicatorWSDelegate();
